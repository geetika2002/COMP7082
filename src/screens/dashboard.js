  ...
  useEffect(() => {
    ...
    <div class="projcard-innerbox">
      ...
      <div class="projcard-textbox">
        <div class="projcard-title">Progress this Week</div>
        ...
        <div class="projcard-description">
          ...
          <p className="titledescription">Out of the Goals you Set:</p><p className='answerdescription'>7 Questions, 3 Interviews, and 10 Articles</p>
          <p className="titledescription">Some Things You Can Work on Today:</p><p className='answerdescription'>Question of the Day.</p>
          <p></p>
        </div>
      </div>
    </div>
  ...
  <article>
    ...
    <div class="article-wrapper">
      ...
      <div class="article-body">
        ...
        <p>
        The lazier way to manage everything using Docker
        </p>
